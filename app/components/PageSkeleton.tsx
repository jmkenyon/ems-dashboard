...
const PageSkeleton = ({children, title, subtitle, size}: PageSkeletonProps) => {
  return (
    <div className="flex flex-col justify-center items-center my-20 mx-2">
    <div className={cn("bg-white shadow-2xl rounded-2xl sm:p-15 p-10 flex flex-col justify-center shadow-black/50 w-full",
